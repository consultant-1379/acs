...
#ifndef ACS_NCLIB_GET_H_
#define ACS_NCLIB_GET_H_
...
class acs_nclib_get: public acs_nclib_rpc_impl {
public:
    acs_nclib_get(acs_nclib::Datastore = acs_nclib::DATASTORE_UNKNOWN);
    virtual ~acs_nclib_get();
...
#endif /* defined(ACS_NCLIB_GET_H_) */
