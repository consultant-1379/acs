/*
 * acs_apgcc_oihandler_V2.h
 *
 *  Created on: Aug 25, 2011
 *      Author: xpaomaz
 */

#ifndef ACS_APGCC_OIHANDLER_V2_H_
#define ACS_APGCC_OIHANDLER_V2_H_
...
class acs_apgcc_oihandler_V2_impl;

/** @class acs_apgcc_oihandler_V2 acs_apgcc_oihandler_V2.h
 *	@brief acs_apgcc_oihandler_V2 class
 *	@author xpaomaz (Paola Mazzone) & xfabron (Fabio Ronca)
 *	@date 2011-08-30
 *	@version R1A
 *
 *	acs_apgcc_oihandler_V2 Class detailed description
 */

class acs_apgcc_oihandler_V2 {
public:
	...
	/** @brief acs_apgcc_oihandler_V2 Default constructor
	 *
	 *	acs_apgcc_oihandler_V2 Constructor of class
	 *
	 *	@remarks Remarks
	 */
	acs_apgcc_oihandler_V2();


	/** @brief acs_apgcc_oihandler_V2 copy constructor
	 *
	 *	acs_apgcc_oihandler_V2 Constructor of class
	 *
	 *	@remarks Remarks
	 */
	acs_apgcc_oihandler_V2(acs_apgcc_oihandler_V2 &oi);


	/** @brief acs_apgcc_oihandler_V2 Destructor
	 *
	 *	acs_apgcc_oihandler_V2 Destructor of class
	 *
	 *	@remarks Remarks
	 */
	 ...
	 *
	 *  @param obj A pointer of instance of acs_apgcc_objectimplementerinterface_V2
	 *
	 *	@return ACS_CC_ReturnType. On success ACS_CC_SUCCESS on Failure ACS_CC_FAILURE
	 *
	 */
	ACS_CC_ReturnType addObjectImpl(acs_apgcc_objectimplementerinterface_V2 *obj);
	 ...
	 *
	 */
	ACS_CC_ReturnType removeObjectImpl(acs_apgcc_objectimplementerinterface_V2 *obj );
	 ...
	 *
	 */
	ACS_CC_ReturnType addClassImpl(acs_apgcc_objectimplementerinterface_V2 *obj, const char * className);
	 ...
	 *	implementer whose name is specified by implName attribute of obj .
	 *
	 *  @param p_obj A pointer of instance of acs_apgcc_objectimplementerinterface_V2
	 *
	 ...
	 *
	 */
	ACS_CC_ReturnType addMultipleClassImpl(acs_apgcc_objectimplementerinterface_V2 *p_obj, vector<string> p_classNameVec);
	 ...
	 *
	 */
	ACS_CC_ReturnType removeClassImpl(acs_apgcc_objectimplementerinterface_V2 *obj, const char * className );
	 ...
	 *
	 */
	ACS_CC_ReturnType removeMultipleClassImpl(acs_apgcc_objectimplementerinterface_V2 *p_obj, vector<string> p_classNameVec );
...
private:
	...
	acs_apgcc_oihandler_V2& operator=(const acs_apgcc_oihandler_V2 &oiHandler);


	acs_apgcc_oihandler_V2_impl *oiHandlerimpl;

};



#endif /* ACS_APGCC_OIHANDLER_V2_H_ */
