...
//ACS_TRA_Logging __CLASS_NAME__::_tra_logger;
...
ACS_TRA_LogResult __CLASS_NAME__::syslogf_errno (int sys_errno, int syslog_priority, ACS_TRA_LogLevel level, const char * format, ...) {
	va_list argp;
...
ACS_TRA_LogResult __CLASS_NAME__::syslogf_errno_source (int sys_errno, int syslog_priority, ACS_TRA_LogLevel level, const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::syslogf_errno_source (int sys_errno, int syslog_priority, const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::syslogf_source (int syslog_priority, ACS_TRA_LogLevel level, const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::syslogf_source (int syslog_priority, const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::logf_source (ACS_TRA_LogLevel level, const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::logf_source (const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::logf_errno_source (int sys_errno, ACS_TRA_LogLevel level, const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::logf_errno_source (int sys_errno, const char * source_func_name, int source_line, const char * format, ...) {
	va_list argp;
	va_start(argp, format);
...
ACS_TRA_LogResult __CLASS_NAME__::vlogf (int sys_errno, int syslog_priority, ACS_TRA_LogLevel level, const char * format, va_list ap) {
	char buffer[8 * 1024];
	int char_count = 0;

	char_count = ::vsnprintf(buffer, ACS_APBM_ARRAY_SIZE(buffer), format, ap);

	if (sys_errno ^ ERRNO_DISABLED_MASK) { // Add system errno information to the log message
		char errno_buf[1024];
		::snprintf(buffer + char_count, ACS_APBM_ARRAY_SIZE(buffer) - char_count, " [errno == %d, errno_text == '%s']",
				sys_errno, ::strerror_r(sys_errno, errno_buf, ACS_APBM_ARRAY_SIZE(errno_buf)));
	}
...
ACS_TRA_LogResult __CLASS_NAME__::vlogf_source (int sys_errno, int syslog_priority, ACS_TRA_LogLevel level, const char * source_func_name, int source_line, const char * format, va_list ap) {
	char buffer[10 * 1024];
	int char_count = 0;

	char_count = ::snprintf(buffer, ACS_APBM_ARRAY_SIZE(buffer), "{%s@@%d} ", source_func_name, source_line);

	char_count += ::vsnprintf(buffer + char_count, ACS_APBM_ARRAY_SIZE(buffer) - char_count, format, ap);
