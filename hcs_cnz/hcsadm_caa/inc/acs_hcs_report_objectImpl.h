//=============================================================================
/**
   @file    acs_hcs_report_objectImpl.h

   @brief Header file for HC module.
          It acts as OI for handling IMM Callbacks of HC report object.
 ...
 */
//=============================================================================
#ifndef ACS_HC_REPORT_OBJECTIMPL_H
#define ACS_HC_REPORT_OBJECTIMPL_H
...
==================================================================== */
/**
 * @brief acs_hcs_report_ObjectImpl
 * acs_hcs_report_ObjectImpl class is extended from acs_apgcc_objectImplementereventhandler_V3.
 * It is having functions to handle IMM callbacks
 *
 */
class acs_hcs_report_ObjectImpl:public acs_apgcc_objectimplementereventhandler_V3 ,public ACE_Task_Base  
{
	/*=====================================================================
...
public:
	 ...
	 */
	acs_hcs_report_ObjectImpl( string ClassName, string p_impName, ACS_APGCC_ScopeT p_scope );
	/*=====================================================================
									   CLASS DESTRUCTOR
	  ==================================================================== */
    	/**
	...
	void getTqDN(string );
//	void updateTqRdnWithNULL();

	/*=====================================================================
					Functions for validations :Malli
	 =======================================================================*/
	 ...
	 */
	ACE_INT32 createValidations(Report_Parameters *request);

	static void updateTQRDN();
	static bool tqCreated;
	static std::string tqRdn;
	static std::string completeReportRdn;
