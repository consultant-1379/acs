...
// .COPYRIGHT
//  COPYRIGHT Ericsson Utvecklings AB, Sweden 1995-2004.
//  All rights reserved.
//
...
const char* const ACS_USA_AntivirusFault  = "AP ANTIVIRUS FUNCTION FAULT";
const char* const ACS_USA_EvaluationCause = "ILLEGAL LOGON ATTEMPTS";
const char* const ACS_USA_Virus           = "AP VIRUS";
const char* const ACS_USA_ZeroOccurPermit = "AP FAULT"; 
