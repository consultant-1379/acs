/*
 * acs_apgcc_oihandler_V2_impl.h
 *
 *  Created on: Aug 25, 2011
 *      Author: xpaomaz
 */

#ifndef ACS_APGCC_OIHANDLER_V2_IMPL_H_
#define ACS_APGCC_OIHANDLER_V2_IMPL_H_
...
/** @class acs_apgcc_oihandler_impl acs_apgcc_oihandler_V2_impl.h
 *	@brief acs_apgcc_oihandler_V2_impl class
 *	@author xpaomaz (Paola Mazzone) & xfabron (Fabio Ronca)
 *	@date 2011-08-30
 *	@version R1A
 *
 *	acs_apgcc_oihandler_V2_impl Class detailed description
 */
...
public:
	...
	/** @brief acs_apgcc_oihandler_V2_impl Default constructor
	 *
	 *	ACS_APGCC_OiHandler Constructor of class
	 *
	 *	@remarks Remarks
	 */
	acs_apgcc_oihandler_V2_impl();
	 ...
	 *	@remarks Remarks
	 */
	acs_apgcc_oihandler_V2_impl(acs_apgcc_oihandler_V2_impl *oiHanlderImp);


	/** @brief acs_apgcc_oihandler_V2_impl Destructor
	 *
...
private:
	...
	static map<SaUint64T,acs_apgcc_objectimplementerinterface_V2 *> implementerList;
...
#endif /* ACS_APGCC_OIHANDLER_V2_IMPL_H_ */
