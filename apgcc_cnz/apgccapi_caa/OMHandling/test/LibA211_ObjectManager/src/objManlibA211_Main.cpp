...
/****************Create obj 1*/
	std::cout << " - insert a char to create an obj objNameCreate1";
	std::cin >> choice;
...
/****************Create obj 2 EXpected FAILURE*/
		std::cout << " - insert  char:A to create an obj objNameCreate2";
		std::cin >> choice;
...
/****************Create obj 3*/
		std::cout << " - insert a char:A to create an obj objNameCreate3";
		std::cin >> choice;
		if (choice == 'A'){
...
/****************Create obj 4*/
		...
		std::cin >> choice;
		if (choice == 'A'){
			res = createObjectTest(/*omHandler_NO_OI, */nameClass, objNameCreate4);
