...
#ifndef ACS_TRAPDS_UTIL_H_
#define ACS_TRAPDS_UTIL_H_
...
#define ACS_TRAPDS_ARRAY_SIZE(array) (sizeof(array)/sizeof(*(array)))
...
# define MAX_PATH_CCH 1000
	...
	static const char EVENT_NAME_SHUTDOWN_SERVICE_HANDLER[]    = "ACS_TRAPDS_SHUTDOWN_SERVICE_HANDLER_EVENT";
	static const char EVENT_NAME_SHUTDOWN[]    = "ACS_TRAPDS_SHUTDOWN";
	...
	bool checkAddress(uint32_t address, uint16_t port);
	bool checkIfAP1();

	EnvironmentType getEnvironment();
	bool uint32_to_ip_format (char (& value_ip) [16], uint32_t value);
	bool getBgciIpAddress(char (& bgcia_str)[2][16], char (& bgcib_str) [2][16], int sysno );


} // End of namespace


#endif /* ACS_TRAPDS_UTIL_H_ */
