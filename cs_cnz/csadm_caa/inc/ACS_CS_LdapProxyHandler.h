/*
 * ACS_CS_LdapProxyHandler.h
 *
 *  Created on: Jun 19, 2013
 *      Author: xlalkak
 */

#ifndef ACS_CS_LDAPPROXYHANDLER_H_
#define ACS_CS_LDAPPROXYHANDLER_H_
...
class ACS_CS_LdapProxyHandler: public acs_apgcc_objectimplementerinterface_V3 {
public:

	ACS_CS_LdapProxyHandler();

	virtual ~ACS_CS_LdapProxyHandler();
...
private:
	...
	ACS_CS_IMMCallbackThread *immLdapWorker;
...
#endif /* ACS_CS_LDAPPROXYHANDLER_H_ */
