...
//
// NAME
//      ACS_LCT_CommandHandler_TSUsers.h
//
...
#ifndef ACS_LCT_COMMANDHANDLER_TSUSERS_H
#define ACS_LCT_COMMANDHANDLER_TSUSERS_H
...
/*=================================================================== */
/**
    @class              ACS_LCT_CommandHandler_TSUsers

    @brief              This class implements the IMM callback functionality 
**/
 /*=================================================================== */

class ACS_LCT_CommandHandler_TSUsers:public acs_apgcc_objectimplementereventhandler_V3,public ACE_Task_Base
{
/*=============================================================================
...
/*=====================================================================
 ...
 ==================================================================== */
	...
	ACS_LCT_CommandHandler_TSUsers(string szobjName,
		                   string szimpName,
        ...
        /*=================================================================== */
                ...
                */
        /*=================================================================== */
	~ACS_LCT_CommandHandler_TSUsers();
