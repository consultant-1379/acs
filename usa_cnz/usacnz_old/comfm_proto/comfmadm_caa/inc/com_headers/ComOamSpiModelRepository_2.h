 ...
 * are enforced to follow the order specified in COM model files.
 *
...
typedef struct ComOamSpiGeneralProperties_2 {
     ...
     * @param[in] handle a general properties handle.
     * @param[out] hidden The hidden property.
     * @return ComOk, or one of the other ComReturnT return codes.
     */
...
typedef struct ComOamSpiMom_2 {
     ...
     * @return ComOk, or one og the other ComReturnT return codes.
     */
     ...
     * @return ComOk, ComNotExist if there are no more MOMs, or on of the other
     * other ComReturnT return codes.
     */
...
typedef struct ComOamSpiMoc_2 {
    ...
    /**
     * Gets the first child containment.
     * @param[in] handle A MOC handle.
    ...
    /**
     * Gets the first parent containment.
     * @param[in] handle A MOC handle.
...
typedef struct ComOamSpiAction_2 {
     ...
     * @return ComOk, ComNotExist if there is no parameters, or one of the
     * other ComReturnT return codes.
     */
