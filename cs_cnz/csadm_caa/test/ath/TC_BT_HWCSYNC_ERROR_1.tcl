...
###########################################################################
# :Title        Command hwcsync error codes
# -------------------------------------------------------------------------
...
# Incorrect usage
# Exit code: 2
cs_send_cmd_exp_errcode "hwcsync -x" 2  


# Unable to connect to server
# Exit code: 117
cs_check_and_stop_service
cs_send_cmd_exp_errcode "hwcsync" 117
