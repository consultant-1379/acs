...
class ACS_SCH_CrmHandler: public acs_apgcc_objectimplementereventhandler_V3, public ACE_Task_Base
{
public:
	/**
	 * @brief
	 ...
	 */
	ACS_SCH_CrmHandler( std::string ClassName, std::string p_impName, ACS_APGCC_ScopeT p_scope);
	ACS_SCH_CrmHandler( std::string ClassName, std::string p_impName, ACS_APGCC_ScopeT p_scope, ACE_Thread_Manager *aThrmgr);
