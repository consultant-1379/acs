...
###########################################################################
# :Title        Command hwcls error codes
# -------------------------------------------------------------------------
...
# Incorrect usage
# Exit code: 2
cs_send_cmd_exp_errcode "hwcls -m" 2

# Illegal option
# Exit code: 5
cs_send_cmd_exp_errcode "hwcls -q" 5

# Incorrect DHCP request method 
# Exit code: 29
cs_send_cmd_exp_errcode "hwcls -d nodhcp" 29

# Incorrect functional board name
# Exit code: 23
cs_send_cmd_exp_errcode "hwcls -n CPBOARD" 23

# Incorrect magazine address
# Exit code: 21
cs_send_cmd_exp_errcode "hwcls -m 2.4.5.5" 21

# Incorrect output format
# Exit code: 31
cs_send_cmd_exp_errcode "hwcls -x output" 31

# Incorrect side
# Exit code: 26
cs_send_cmd_exp_errcode "hwcls -e 1" 26

# Incorrect slot position
# Exit code: 22
cs_send_cmd_exp_errcode "hwcls -s 26" 22

# Incorrect system number
# Exit code: 24
cs_send_cmd_exp_errcode "hwcls -y A" 24

# Incorrect system type
# Exit code: 30
cs_send_cmd_exp_errcode "hwcls -t CPTYPE" 30

# Unable to connect to server
# Exit code: 117
cs_check_and_stop_service
# cs_send_cmd_exp_errcode "hwcls" 117
