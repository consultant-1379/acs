/**
   @file    acs_rtr_hashkey_objectImpl.h
...
#ifndef ACS_RTR_HASHKEY_OBJECTIMPL_H
#define ACS_RTR_HASHKEY_OBJECTIMPL_H
...
==================================================================== */
/**
 * @brief ACS_RTR_HashKey_ObjectImpl
 * ACS_RTR_HashKey_ObjectImpl class is extended from acs_apgcc_objectImplementereventhandler_V3.
 * It is having functions to handle IMM callbacks
 *
 */

class ACS_RTR_HashKey_ObjectImpl : public acs_apgcc_objectimplementereventhandler_V3
{
 public:
...
private:
	...
	/** @brief 	validateHashKey	
	*
	*/
	bool validateHashKey(const std::string& hashKeyVal);
