/*
 * acs_apgcc_adminoperationasync_V2_R1.h
 *
 *  Created on: Nov 15, 2011
 *      Author: xpaomaz
 */

#ifndef ACS_APGCC_ADMINOPERATIONASYNC_V2_R1_H_
#define ACS_APGCC_ADMINOPERATIONASYNC_V2_R1_H_
...
/** @class acs_apgcc_adminoperationasync_V2 acs_apgcc_adminoperationasync_V2.h
 *	@brief acs_apgcc_adminoperationasync_V2 class provides IMM Administrative Operations Async implementation
 *	@brief interface
 *	@author xpaomaz
 *	@date 2011-11-07
 *	@version R1A
 *
 *	acs_apgcc_adminoperationasync_V2 Class detailed description: this class can be used by APG applications to
 *	acs_apgcc_adminoperationasync_V2 to call Asycronous IMM Administrative Operations.
 */
...
public:
	...
	/** @brief acs_apgcc_adminoperationasync_V2 Default constructor
	 *
	 *	acs_apgcc_adminoperationasync_V2 Constructor of class
	 *
	 *	@remarks Remarks
	 */
	acs_apgcc_adminoperationasync_V2_R1();

	/** @brief acs_apgcc_adminoperationasync_V2 Copy constructor
	 *
	 *	acs_apgcc_adminoperationasync_V2 Copy Constructor of class
	 *
	 *	@remarks Remarks
	 */
	acs_apgcc_adminoperationasync_V2_R1(acs_apgcc_adminoperationasync_V2_R1& objRef);

	/** @brief acs_apgcc_adminoperationasync_V2 distructor
	 *
	 *	acs_apgcc_adminoperation distructor of class
	 *
	 *	@remarks Remarks
	 */
	virtual ~acs_apgcc_adminoperationasync_V2_R1();


	/**
	 *
	 * Init method: used to Initialize Interaction between the calling process and IMM.
	 * Each application that intends to use acs_apgcc_adminoperationasync_V2 class must call this method before performing
	 * any action.
     * @param : none
	 ...
	 * After calling this method no other operation on IMM could be performed using acs_apgcc_adminoperationasync_V2.
	 ...
	 * @return ACS_CC_ReturnType. On success ACS_CC_SUCCESS on Failure ACS_CC_FAILURE
	 */
	virtual void objectManagerAdminOperationCallback( ACS_APGCC_InvocationType invocation, int returnVal , int error, ACS_APGCC_AdminOperationParamType** outParamVector )=0;
...
private:
	...
	acs_apgcc_adminoperationasync_V2_R1& operator=(const acs_apgcc_adminoperationasync_V2_R1 &adminOperationAsync);

	acs_apgcc_adminoperationasync_V2_R1_impl *adminoperationAsync_impl;


};


#endif /* ACS_APGCC_ADMINOPERATIONASYNC_V2_R1_H_ */
