/**
   @file    acs_rtr_cpstatistics_impl.h

   @brief Header file for RTR module.
          It acts as OI for handling IMM Callbacks of RTR ACS_RTR_CpStatistics_ObjectImpl object.
...
#ifndef ACS_RTR_CPSTATISTICS_OBJECTIMPL_H
#define ACS_RTR_CPSTATISTICS_OBJECTIMPL_H
...
struct CpStatisticsInfo{
			...
			uint64_t recordsLost;
			uint64_t recordsSkipped;
};
...
==================================================================== */
/**
 * @brief ACS_RTR_CpStatistics_ObjectImpl
 * ACS_RTR_CpStatistics_ObjectImpl class is extended from acs_apgcc_objectImplementereventhandler_V3.
 * It is having functions to handle IMM callbacks
 *
 */
class ACS_RTR_CpStatistics_ObjectImpl : public acs_apgcc_objectimplementereventhandler_V3
{
 ...
 public:
	...
	*/
	ACS_RTR_CpStatistics_ObjectImpl(ACS_RTR_Server* serverObject);

    /**
   	* @brief
   	* destructor
   	*/
	~ACS_RTR_CpStatistics_ObjectImpl();
 ...
 private:
	...
	*
	*/
	void updateRunTimeAttributes(const char* objectDN, CpStatisticsInfo& cpStatisticsInfo);
	...
	*
	*/
	bool getCpId(const std::string& objectDN, short& cpId);
