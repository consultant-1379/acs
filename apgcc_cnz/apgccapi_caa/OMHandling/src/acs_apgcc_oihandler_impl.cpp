...
map<SaUint64T,ACS_APGCC_ObjectImplementerInterface *> acs_apgcc_oihandler_impl::implementerList;



acs_apgcc_oihandler_impl::acs_apgcc_oihandler_impl(){
...
acs_apgcc_oihandler_impl::acs_apgcc_oihandler_impl(acs_apgcc_oihandler_impl *oiHanlderImp){
...
ACS_CC_ReturnType acs_apgcc_oihandler_impl::addObjectImpl(ACS_APGCC_ObjectImplementerInterface *obj){
	...
	immCallbacks.saImmOiCcbObjectCreateCallback = acs_apgcc_oihandler_impl::CreateCallback;
	immCallbacks.saImmOiCcbObjectModifyCallback = acs_apgcc_oihandler_impl::ModifyCallback;
	immCallbacks.saImmOiCcbObjectDeleteCallback = acs_apgcc_oihandler_impl::DeleteCallback;
	immCallbacks.saImmOiCcbCompletedCallback = acs_apgcc_oihandler_impl::CompletedCallback;
	immCallbacks.saImmOiCcbApplyCallback = acs_apgcc_oihandler_impl::ApplyCallback;
	immCallbacks.saImmOiCcbAbortCallback = acs_apgcc_oihandler_impl::AbortCallback;

	immCallbacks.saImmOiRtAttrUpdateCallback = acs_apgcc_oihandler_impl::OiRtAttUpdateCallback;
	...
	if ( errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::addObjectImpl():saImmOiInitialize_2:FAILED", LOG_LEVEL_ERROR);
	 ...
	 * ACS_APGCC_ObjectImplementerInterface passed as parameter**/
	...
	if( errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::addObjectImpl():saImmOiImplementerSet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if( errorCode != SA_AIS_OK ){
		...
		log.Write("ACS_APGCC_OiHandler::addObjectImpl():saImmOiObjectImplementerSet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if( errorCode != SA_AIS_OK ){
		...
		log.Write("ACS_APGCC_OiHandler::addObjectImpl():saImmOiSelectionObjectGet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
ACS_CC_ReturnType acs_apgcc_oihandler_impl::addClassImpl(ACS_APGCC_ObjectImplementerInterface *obj, const char * className){
	...
	if ( errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::addClassImpl():saImmOiInitialize_2:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if( errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::addClassImpl():saImmOiImplementerSet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if( errorCode != SA_AIS_OK ){
		...
		log.Write("ACS_APGCC_OiHandler::addClassImpl():saImmOiClassImplementerSet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if( errorCode != SA_AIS_OK ){
		...
		log.Write("ACS_APGCC_OiHandler::addClassImpl():saImmOiSelectionObjectGet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
ACS_CC_ReturnType acs_apgcc_oihandler_impl::addMultipleClassImpl(ACS_APGCC_ObjectImplementerInterface *p_obj, vector<string> p_classNameVec){
...
//	ACE_UNUSED_ARG(p_classNameVec);
	...
	if(p_obj == 0){
		...
		log.Write("ACS_APGCC_OiHandler::addMultipleClassImpl():FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if ( errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::addMultipleClassImpl():saImmOiInitialize_2:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if( errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::addMultipleClassImpl():saImmOiImplementerSet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
		...
		if (errorCode != SA_AIS_OK){
			...
			log.Write("ACS_APGCC_OiHandler::Finalize():addMultipleClassImpl:FAILED", LOG_LEVEL_ERROR);
			log.Write(buffer, LOG_LEVEL_ERROR);
	...
	for(int i=0; i<(int)p_classNameVec.size(); i++){
		...
		if( errorCode != SA_AIS_OK ){
			...
			log.Write("ACS_APGCC_OiHandler::addMultipleClassImpl():saImmOiClassImplementerSet:FAILED", LOG_LEVEL_ERROR);
			log.Write(buffer, LOG_LEVEL_ERROR);
			...
			for(int j=0; j<i; j++){
				...
				log.Write("ACS_APGCC_OiHandler::addMultipleClassImpl():saImmOiClassImplementerRelease:FAILED", LOG_LEVEL_ERROR);
				log.Write(buffer, LOG_LEVEL_ERROR);
			}
	...
	if( errorCode != SA_AIS_OK ){
		...
		log.Write("ACS_APGCC_OiHandler::addMultipleClassImpl():saImmOiSelectionObjectGet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
ACS_CC_ReturnType acs_apgcc_oihandler_impl::removeObjectImpl(ACS_APGCC_ObjectImplementerInterface *obj){
	...
	if (errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::removeObjectImpl():saImmOiObjectImplementerRelease:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	ACS_APGCC_ObjectImplementer_EventHandler * p = dynamic_cast<ACS_APGCC_ObjectImplementer_EventHandler *>(obj);
	if(p){
		p->release_handle();
	}
...
ACS_CC_ReturnType acs_apgcc_oihandler_impl::removeClassImpl(ACS_APGCC_ObjectImplementerInterface *obj, const char * className ){
	...
	if (errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::removeClassImpl():saImmOiClassImplementerRelease:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
//TO BE DEFINE
ACS_CC_ReturnType acs_apgcc_oihandler_impl::removeMultipleClassImpl(ACS_APGCC_ObjectImplementerInterface *p_obj, vector<string> p_classNameVec ){
...
//	ACE_UNUSED_ARG(p_classNameVec);
	...
	if(p_obj == 0){
		...
		log.Write("ACS_APGCC_OiHandler::removeMultipleClassImpl():FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	for(int i=0; i<(int)p_classNameVec.size(); i++){
		...
		if (errorCode != SA_AIS_OK){
			...
			log.Write("ACS_APGCC_OiHandler::removeMultipleClassImpl():saImmOiClassImplementerRelease:FAILED", LOG_LEVEL_ERROR);
			log.Write(buffer, LOG_LEVEL_ERROR);
	...
	/** If the object obj is instance of class ACS_APGCC_ObjectImplementer_EventHandler is necessary
	 * to call the method release_handle() to remove the handle from teh reactor**/
	ACS_APGCC_ObjectImplementer_EventHandler * p = dynamic_cast<ACS_APGCC_ObjectImplementer_EventHandler *>(p_obj);
	if(p){
		p->release_handle();
	}
...
ACS_CC_ReturnType acs_apgcc_oihandler_impl::Finalize (SaUint64T immHandle ){
	...
	if (errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::Finalize():saImmOiImplementerClear:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if (errorCode != SA_AIS_OK){
		...
		log.Write("ACS_APGCC_OiHandler::Finalize():saImmOiFinalize:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
SaAisErrorT acs_apgcc_oihandler_impl::CreateCallback(SaImmOiHandleT immOiHandle, SaImmOiCcbIdT ccbId,
	...
	ACS_APGCC_ObjectImplementerInterface *obj = (ACS_APGCC_ObjectImplementerInterface *)(acs_apgcc_oihandler_impl::implementerList.find(immOiHandle)->second);
...
SaAisErrorT acs_apgcc_oihandler_impl::DeleteCallback(SaImmOiHandleT immOiHandle, SaImmOiCcbIdT ccbId,
...
SaAisErrorT acs_apgcc_oihandler_impl::ModifyCallback(SaImmOiHandleT immOiHandle, SaImmOiCcbIdT ccbId,
		const SaNameT *objectName,
...
SaAisErrorT acs_apgcc_oihandler_impl::CompletedCallback(SaImmOiHandleT immOiHandle, SaImmOiCcbIdT ccbId){
...
void acs_apgcc_oihandler_impl::AbortCallback(SaImmOiHandleT immOiHandle, SaImmOiCcbIdT ccbId){
...
void acs_apgcc_oihandler_impl::ApplyCallback(SaImmOiHandleT immOiHandle, SaImmOiCcbIdT ccbId){
...
SaAisErrorT acs_apgcc_oihandler_impl::OiRtAttUpdateCallback(SaImmOiHandleT immOiHandle,
			const SaNameT *objectName,
...
std::string acs_apgcc_oihandler_impl::getErrorText(int p_errorId){
