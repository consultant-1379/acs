//=============================================================================
/**
 *  @file    acs_ssu_disk_mon_objectimpl.h
 *
 *  @copyright  Ericsson AB, Sweden 2010. All rights reserved.
 *
 *  @author 2011-10-21 by XRAMMAT
 *
 *  @documentno
 *
 *  @brief  It acts as OI for handling IMM Callbacks of SSU disk monitor objects.
 *
 */
//=============================================================================
#ifndef ACS_SSU_DISKMONOBJECTIMPL_H
#define ACS_SSU_DISKMONOBJECTIMPL_H
...
/**
 * @brief ACS_SSU_DiskMon_ObjectImpl
 * ACS_SSU_DiskMon_ObjectImpl class is extended from acs_apgcc_objectImplementereventhandler_V2.
 * It is having functions to handle IMM callbacks
 *
 */

class ACS_SSU_DiskMon_ObjectImpl:public acs_apgcc_objectimplementereventhandler_V2,public ACE_Task_Base
{
public:
	/**
	 * @brief
	 ...
	 */
	ACS_SSU_DiskMon_ObjectImpl(string szimpName );
   /**
   	* @brief
   	* destructor
   	*/
	~ACS_SSU_DiskMon_ObjectImpl();
	/**
