...
#ifndef ACS_CS_VLAN_GetNetworkTableResponse_h
#define ACS_CS_VLAN_GetNetworkTableResponse_h 1
...
class ACS_CS_VLAN_GetNetworkTableResponse : public ACS_CS_BasicResponse  //## Inherits: <unnamed>%461B3FF10332
{

public:
	ACS_CS_VLAN_GetNetworkTableResponse();

	ACS_CS_VLAN_GetNetworkTableResponse(const ACS_CS_VLAN_GetNetworkTableResponse &right);

	virtual ~ACS_CS_VLAN_GetNetworkTableResponse();
	...
	void setBoardId(unsigned short ver);
...
private:
	ACS_CS_VLAN_GetNetworkTableResponse & operator=(const ACS_CS_VLAN_GetNetworkTableResponse &right);
