...
ACS_CS_Trace_TDEF(ACS_CS_CPGroup_GetGroupMembersResponse_TRACE);
...
ACS_CS_CPGroup_GetGroupMembersResponse::ACS_CS_CPGroup_GetGroupMembersResponse()
      : logicalClock(0),
        cpArray(0),
        cpCount(0)
{
...
ACS_CS_CPGroup_GetGroupMembersResponse::ACS_CS_CPGroup_GetGroupMembersResponse(const ACS_CS_CPGroup_GetGroupMembersResponse &right)
...
ACS_CS_CPGroup_GetGroupMembersResponse::~ACS_CS_CPGroup_GetGroupMembersResponse()
{
 ...
 ACS_CS_Protocol::CS_Primitive_Identifier ACS_CS_CPGroup_GetGroupMembersResponse::getPrimitiveType () const
{

   return ACS_CS_Protocol::Primitive_GetGroupMembersResponse;

}

 int ACS_CS_CPGroup_GetGroupMembersResponse::setBuffer (const char *buffer, int size)
{

   if (buffer == 0)								// Check for valid memory
	{
		ACS_CS_TRACE((ACS_CS_CPGroup_GetGroupMembersResponse_TRACE,
			"(%t) ACS_CS_CPGroup_GetGroupMembersResponse::setBuffer()\n"
			"Error: NULL pointer\n" ));
 ...
 int ACS_CS_CPGroup_GetGroupMembersResponse::getBuffer (char *buffer, int size) const
{

   if (buffer == 0)				// Check for valid memory
	{
		ACS_CS_TRACE((ACS_CS_CPGroup_GetGroupMembersResponse_TRACE,
			"(%t) ACS_CS_CPGroup_GetGroupMembersResponse::getBuffer()\n"
			"Error: NULL pointer\n" ));
 ...
 short unsigned ACS_CS_CPGroup_GetGroupMembersResponse::getLength () const
{
 ...
 ACS_CS_Primitive * ACS_CS_CPGroup_GetGroupMembersResponse::clone () const
{

   return new ACS_CS_CPGroup_GetGroupMembersResponse(*this);

}

 short unsigned ACS_CS_CPGroup_GetGroupMembersResponse::getLogicalClock () const
{
 ...
 void ACS_CS_CPGroup_GetGroupMembersResponse::setLogicalClock (unsigned short clock)
{
 ...
 int ACS_CS_CPGroup_GetGroupMembersResponse::getResponseArray (unsigned short *array, unsigned short size) const
{

   if (array == 0)									// Check for valid memory
	{
		ACS_CS_TRACE((ACS_CS_CPGroup_GetGroupMembersResponse_TRACE,
			"(%t) ACS_CS_CPGroup_GetGroupMembersResponse::getResponseArray()\n"
			"Error: NULL pointer\n" ));
 ...
 short unsigned ACS_CS_CPGroup_GetGroupMembersResponse::getResponseCount () const
{
 ...
 int ACS_CS_CPGroup_GetGroupMembersResponse::setResponseArray (const unsigned short *array, unsigned short size)
{

   if (array == 0)									// Check for valid memory
	{
		ACS_CS_TRACE((ACS_CS_CPGroup_GetGroupMembersResponse_TRACE,
			"(%t) ACS_CS_CPGroup_GetGroupMembersResponse::setResponseArray()\n"
			"Error: NULL pointer\n" ));
