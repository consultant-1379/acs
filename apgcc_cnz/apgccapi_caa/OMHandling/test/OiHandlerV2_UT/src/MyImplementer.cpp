...
MyImplementer::MyImplementer(string p_impName ):acs_apgcc_objectimplementereventhandler_V2(p_impName){

	value = 0;
}

MyImplementer::MyImplementer(string p_objName, string p_impName, ACS_APGCC_ScopeT p_scope ): acs_apgcc_objectimplementereventhandler_V2(p_objName, p_impName, p_scope){
