...
###########################################################################
# :Title        Command nech error codes
# -------------------------------------------------------------------------
...
# Exit code: 115
cs_send_cmd_exp_errcode "nech -i NEID" 115
...
# Incorrect usage
# Exit code: 2
cs_send_cmd_exp_errcode "nech -q" 2

# Illegal Network Element Identity
# Exit code: 41
cs_send_cmd_exp_errcode "nech -i \"Network Element value too long exceeding 24 characters\"" 41

# Incorrect cluster operation mode
# Exit code: 44
#cs_send_cmd_exp_errcode "nech -m INCORRECT_OPTION" 44

# Incorrect profile
# Exit code: 45
#cs_send_cmd_exp_errcode "nech -p INCORRECT_PROFILE" 45

# Unable to connect to server
# Exit code: 117
cs_check_and_stop_service
# cs_send_cmd_exp_errcode "nech -i NEID" 117
