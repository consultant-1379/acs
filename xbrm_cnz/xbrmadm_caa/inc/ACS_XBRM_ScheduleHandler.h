 ...
 *
 ----------------------------------------------------------------------*/ /**
 *
 * @file ACS_XBRM_ScheduleHandler.h
 *
 * @brief
 * ACS_XBRM_ScheduleHandler Class for SystemBrmBackupScheduler IMM Handling
 *
 * @details
 * ACS_XBRM_ScheduleHandler is used as an OI interface handling IMM
...
#ifndef ACS_XBRM_SCHEDULEHANDLER_H
#define ACS_XBRM_SCHEDULEHANDLER_H
...
class ACS_XBRM_ScheduleHandler: 
...
public ACE_Task_Base {
    public:
         ...
         */
        ACS_XBRM_ScheduleHandler(std::string ClassName, std::string p_impName, ACS_APGCC_ScopeT p_scope);
        ACS_XBRM_ScheduleHandler(std::string ClassName, std::string p_impName, ACS_APGCC_ScopeT p_scope, ACE_Thread_Manager *aThrmgr);

        /**
         * @brief
         * destructor
         */
        ~ACS_XBRM_ScheduleHandler();
        ...
        */
        ...
        acs_apgcc_oihandler_V3  *theScheduleHandler;
