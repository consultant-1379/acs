/*=================================================================== */
/**
   @file   acs_lm_northbound_objectImplementer.h
...
==================================================================== */
#ifndef acs_lm_northbound_objectImplementer_H
#define acs_lm_northbound_objectImplementer_H
/*=====================================================================
...
/**
 * @brief acs_lm_northbound_objectImplementer
 * acs_lm_northbound_objectImplementer class is extended from acs_apgcc_objectImplementereventhandler_V2.
 * It is having functions to handle IMM callbacks
 *
 */

class acs_lm_northbound_objectImplementer:public acs_apgcc_objectimplementereventhandler_V3,public ACE_Task_Base
{
...
public:
	...
	/*=================================================================== */
	/**
	            @brief       Default constructor for acs_lm_northbound_objectImplementer
   ...
   acs_lm_northbound_objectImplementer(string szimpName );
   /*=================================================================== */
   /**
                @brief       Default destructor for acs_lm_northbound_objectImplementer
   ...
   ~acs_lm_northbound_objectImplementer();
   /*=================================================================== */
     /**
    ...
    /*=================================================================== */
    /**
     *  @brief  lmNorthboundOI_svc
     *
     *
     *  @return                                :ACE_INT32
     */
    /*=================================================================== */
        ACE_INT32 lmNorthboundOI_svc();
	...
	void setOmHandler(OmHandler*);
	 ...
	 /*=====================================================================*/
        ...
        /**
            ...
            @param     almnorthboundObjectImplementer
	...
	ACS_CC_ReturnType setupLMNorthboundOIThread(acs_lm_northbound_objectImplementer *almNorthboundObjectImplementer);


        /*=====================================================================*/
        /**
            @brief    LMNorthboundOIFunc
         ...
         */
        /*=====================================================================*/
	 static ACE_THR_FUNC_RETURN LMNorthboundOIFunc(void*);
            ...
            */
            ...
            ACS_CC_ReturnType setLMNorthBoundObjectImplementer();
