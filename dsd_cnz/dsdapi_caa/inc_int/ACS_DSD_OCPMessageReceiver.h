#ifndef HEADER_GUARD_CLASS__ACS_DSD_OCPMessageReceiver
#define HEADER_GUARD_CLASS__ACS_DSD_OCPMessageReceiver ACS_DSD_OCPMessageReceiver

/** @file ACS_DSD_OCPMessageReceiver.h
 *	@brief
...
#define __CLASS_NAME__ HEADER_GUARD_CLASS__ACS_DSD_OCPMessageReceiver

#ifdef ACS_DSD_API_TRACING_ACTIVE
extern ACS_DSD_API_CLASS_TRACER_DECL(__CLASS_NAME__);
#endif

/** @class ACS_DSD_OCPMessageReceiver ACS_DSD_OCPMessageReceiver.h
 *	@brief ACS_DSD_OCPMessageReceiver class
 *	@author xnicmut (Nicola Muto)
 *	@date 2010-11-09
 *	@version 1.0.1
 *
 *	ACS_DSD_OCPMessageReceiver Class detailed description
 */
class __CLASS_NAME__ : public ACS_DSD_Receiver {
	...
	//==============//
public:
	/** @brief ACS_DSD_OCPMessageReceiver Default constructor
	 *
	 *	ACS_DSD_OCPMessageReceiver Constructor detailed description
	 *
...
private:
	/** @brief ACS_DSD_OCPMessageReceiver Copy constructor
	 *
	 *	ACS_DSD_OCPMessageReceiver Copy Constructor detailed description
	 *
	...
	//============//
public:
	/** @brief ACS_DSD_OCPMessageReceiver Destructor
	 *
	 *	ACS_DSD_OCPMessageReceiver Destructor detailed description
	 *
	 *	@remarks Remarks
	 */
...
#endif // HEADER_GUARD_CLASS__ACS_DSD_OCPMessageReceiver
