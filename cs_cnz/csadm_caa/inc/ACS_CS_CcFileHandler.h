/*
 * ACS_CS_CcFileHandler.h
 *
 *  Created on: Feb 5, 2013
 *      Author: eanform
 */

#ifndef ACS_CS_CCFILEHANDLER_H_
#define ACS_CS_CCFILEHANDLER_H_
...
class ACS_CS_CcFileHandler : public ACS_CS_ImmIncomingHandler
{
public:

	ACS_CS_CcFileHandler(ACS_APGCC_OiHandle oiHandle, ACS_APGCC_CcbId ccbId,
