//=============================================================================
/**
   @file    acs_hcs_calenderPeriodicEvent_objectImpl.h

   @brief Header file for HC module.
          It acts as OI for handling IMM Callbacks of HC calenderPeriodicEvent object.
 ...
 */
//=============================================================================
#ifndef ACS_HC_CALENDERPERIODICEVENT_OBJECTIMPL_H
#define ACS_HC_CALENDERPERIODICEVENT_OBJECTIMPL_H
...
==================================================================== */
/**
 * @brief acs_hcs_calenderPeriodicEvent_ObjectImpl
 * acs_hcs_calenderPeriodicEvent_ObjectImpl class is extended from acs_apgcc_objectImplementereventhandler_V3.
 * It is having functions to handle IMM callbacks
 *
 */
class acs_hcs_calenderPeriodicEvent_ObjectImpl:public acs_apgcc_objectimplementereventhandler_V3 ,public ACE_Task_Base
{
	/*=====================================================================
	...
	public:
		 ...
		 */
		acs_hcs_calenderPeriodicEvent_ObjectImpl( string ClassName, string p_impName, ACS_APGCC_ScopeT p_scope );
		...
		* destructor
		*/
		~acs_hcs_calenderPeriodicEvent_ObjectImpl();
		...
		ACE_INT32 createValidations(string & startTime,string stopTime);
		 ...
		 /**
                 ...
                 *  @param time       : value of start time
		 ...
		 *  @param nextScheduleDate : value of the next schedule date which need to update
                 *  return bool       : return 'true' if augmentation is successful else 'false' would be return
                 */
                bool augmentcall(ACS_APGCC_OiHandle oiHandle, ACS_APGCC_CcbId ccbId, string time, string rdn, int callback, bool isStartTimeProvided, string date);
		...
		/*
                 ...
                 */
		static bool delete_Cevent_flag;

		/*
                 * @brief  static variable to hold the complete rdn of calendar periodic event
                   Ex:calendarPeriodicEventId=1,jobSchedulerId=1,jobId=HC,HealthCheckhealthCheckMId=1
                 */
		static std::string completeCeventRdn;


		/**
                 * @brief This is the dn of calendar event that is being created or modified. 
                 */
		static string newDn;
