...
acs_nclib_get_config::acs_nclib_get_config(acs_nclib::Datastore ds):
acs_nclib_rpc_impl(acs_nclib::OP_GETCONFIG),
datastore(ds)
{
    
}

acs_nclib_get_config::~acs_nclib_get_config()
{
    clear_filters();
}

void acs_nclib_get_config::add_filter(acs_nclib_filter* new_filter)
{
...
void acs_nclib_get_config::clear_filters()
{
...
char* acs_nclib_get_config::dump_operation() const
{
    ...
    strcat(return_value, ACS_NCLIB_GETCONFIG_TAG::HEADER);
...
//        delete[] filter_content;
//    }
    strcat(return_value, ACS_NCLIB_GETCONFIG_TAG::TRAILER);
    
    return return_value;
    
}

void acs_nclib_get_config::dump_operation(std::string& return_value) const {

    return_value = ACS_NCLIB_GETCONFIG_TAG::HEADER;
...
//    }
    ...
    return_value += ACS_NCLIB_GETCONFIG_TAG::TRAILER;    
}

void acs_nclib_get_config::set_source(acs_nclib::Datastore dat)
{
	datastore = dat;
}
