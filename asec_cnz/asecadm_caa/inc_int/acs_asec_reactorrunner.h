...
#ifndef ACS_ASEC_REACTORRUNNER_H_
#define ACS_ASEC_REACTORRUNNER_H_
...
//----------------------------------------------------------------------------
class ACS_ASEC_ReactorRunner: public ACE_Task<ACE_SYNCH> {
	
public:
	
   ACS_ASEC_ReactorRunner(ACE_Reactor* reactor, const std::string& name);
   int open();
   int svc();
   void stop();
...
#endif /* ACS_ASEC_REACTORRUNNER_H_ */
