...
void classImplTest_4(){
	...
	ASSERTM("acs_apgcc_oihandler_V3::addClassImpl for implementer_1 ", result == ACS_CC_SUCCESS);

	result = oiHandler.addClassImpl(&implementer_2, nameClass_2);
	ASSERTM("acs_apgcc_oihandler_V3::addClassImpl for implementer_2", result == ACS_CC_FAILURE);

	result = oiHandler.removeClassImpl(&implementer_1, nameClass_1);
	ASSERTM("acs_apgcc_oihandler_V3::removeClassImpl for implementer_1 ", result == ACS_CC_SUCCESS);
...
void classImplTest_5(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " acs_apgcc_oihandler_V3::removeClassImpl(...) " << endl;
	...
	result = oiHandler.addClassImpl(&implementer_1, nameClass);
	ASSERTM("acs_apgcc_oihandler_V3::addClassImpl  ", result == ACS_CC_SUCCESS);
	if(result == ACS_CC_SUCCESS){
	...
	result = oiHandler.removeClassImpl(&implementer_1, nameClass);
	ASSERTM("acs_apgcc_oihandler_V3::removeClassImpl ", result == ACS_CC_SUCCESS);
	if(result == ACS_CC_SUCCESS){
...
void classImplTest_6(){
	...
	result = oiHandler.removeClassImpl(&implementer_1, nameClass);
	ASSERTM("acs_apgcc_oihandler_V3::removeClassImpl ", result == ACS_CC_FAILURE);
...
void objImplTest_1(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " acs_apgcc_oihandler_V3::addObjectImpl(...) " << endl;
	...
	ASSERTM("acs_apgcc_oihandler_V3::addObjectImpl  ", result == ACS_CC_SUCCESS);

	sleep(1);

	result = oiHandler.removeObjectImpl(&implementer_1);
	ASSERTM("acs_apgcc_oihandler_V3::removeObjectImpl ", result == ACS_CC_SUCCESS);
...
void objImplTest_2(){
	...
	ASSERTM("acs_apgcc_oihandler_V3::addObjectImpl  ", result == ACS_CC_FAILURE);

	sleep(1);

	result = oiHandler.removeObjectImpl(&implementer_1);
	ASSERTM("acs_apgcc_oihandler_V3::removeObjectImpl - implementer_1 ", result == ACS_CC_SUCCESS);

	result = oiHandler.removeObjectImpl(&implementer_2);
//	ASSERTM("acs_apgcc_oihandler_V3::removeObjectImpl ", result == ACS_CC_FAILURE);
...
void objImplTest_5(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " acs_apgcc_oihandler_V3::removeObjectImpl(...) " << endl;
...
void ModifyCallbackTest(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " acs_apgcc_oihandler_V3::ModifyCallback(...) " << endl;
...
void abortCallbackTest(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " acs_apgcc_oihandler_V3::AbortCallback(...) " << endl;
...
void updateCallbackTest(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " acs_apgcc_oihandler_V3::OiRtAttUpdateCallback(...) " << endl;
...
//	parToModify_6.attrValues = 0;
	...
	/******************************CHANGE CACHED RUNTIME ATTRIBUTE - MORE ATTRIBUTE *************************************/

	cout<< "Waiting for IMMLIST command to test updateCallback with more than an attributes" <<endl;
