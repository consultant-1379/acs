#ifndef HEADER_GUARD_CLASS__acs_aca_logger
#define HEADER_GUARD_CLASS__acs_aca_logger acs_aca_logger

/** @file acs_aca_logger.h
 *	@brief
 ...
 * Logging macros
 */
#if !defined (ACS_ACA_LOGGER_CLASS)
#	define ACS_ACA_LOGGER_CLASS acs_aca_logger

#	define ACS_ACA_LOGGER_METHOD logf
#	define ACS_ACA_LOGGER_ERRNO_METHOD logf_errno
#	define ACS_ACA_SYSLOGGER_METHOD syslogf
#	define ACS_ACA_SYSLOGGER_ERRNO_METHOD syslogf_errno

#	define ACS_ACA_LOGGER_METHOD_SOURCE logf_source
#	define ACS_ACA_LOGGER_ERRNO_METHOD_SOURCE logf_errno_source
#	define ACS_ACA_SYSLOGGER_METHOD_SOURCE syslogf_source
#	define ACS_ACA_SYSLOGGER_ERRNO_METHOD_SOURCE syslogf_errno_source

# define ACS_ACA_DUMPER_METHOD dump
# define ACS_ACA_DEFAULT_DUMP_LINE_LENGTH 16
# define ACS_ACA_DEFAULT_DUMP_SIZE 128
#endif


#if !defined (ACS_ACA_LOG_IMPL)
#	define ACS_ACA_LOG_IMPL(level, ...) ACS_ACA_LOGGER_CLASS::ACS_ACA_LOGGER_METHOD(level, __VA_ARGS__)
#	define ACS_ACA_LOG_ERRNO_IMPL(sys_errno, level, ...) \
	ACS_ACA_LOGGER_CLASS::ACS_ACA_LOGGER_ERRNO_METHOD(sys_errno, level, __VA_ARGS__)
#	define ACS_ACA_SYSLOG_IMPL(syslog_priority, level, ...) \
	ACS_ACA_LOGGER_CLASS::ACS_ACA_SYSLOGGER_METHOD(syslog_priority, level, __VA_ARGS__)
#	define ACS_ACA_SYSLOG_ERRNO_IMPL(sys_errno, syslog_priority, level, ...) \
	ACS_ACA_LOGGER_CLASS::ACS_ACA_SYSLOGGER_ERRNO_METHOD(sys_errno, syslog_priority, level, __VA_ARGS__)

#	define ACS_ACA_LOG_SOURCE_IMPL(level, source, line, ...) \
	ACS_ACA_LOGGER_CLASS::ACS_ACA_LOGGER_METHOD_SOURCE(level, source, line, __VA_ARGS__)
#	define ACS_ACA_LOG_SOURCE_ERRNO_IMPL(sys_errno, level, source, line, ...) \
	ACS_ACA_LOGGER_CLASS::ACS_ACA_LOGGER_ERRNO_METHOD_SOURCE(sys_errno, level, source, line, __VA_ARGS__)
#	define ACS_ACA_SYSLOG_SOURCE_IMPL(syslog_priority, level, source, line, ...) \
	ACS_ACA_LOGGER_CLASS::ACS_ACA_SYSLOGGER_METHOD_SOURCE(syslog_priority, level, source, line, __VA_ARGS__)
#	define ACS_ACA_SYSLOG_SOURCE_ERRNO_IMPL(sys_errno, syslog_priority, level, source, line, ...) \
	ACS_ACA_LOGGER_CLASS::ACS_ACA_SYSLOGGER_ERRNO_METHOD_SOURCE(sys_errno, syslog_priority, level, source, line, __VA_ARGS__)
#endif

inline int ACS_ACA_LOG_NO_LOGGING () { return 0; }

#ifdef ACS_ACA_HAS_LOGGING
#	ifdef ACS_ACA_LOGGING_HAS_SOURCE_INFO
#		ifdef ACS_ACA_LOGGING_USE_PRETTY_FUNCTION
#			define ACS_ACA_LOG(level, ...) ACS_ACA_LOG_SOURCE_IMPL(level, __PRETTY_FUNCTION__, __LINE__, __VA_ARGS__)
#			define ACS_ACA_LOG_ERRNO(sys_errno, level, ...) ACS_ACA_LOG_SOURCE_ERRNO_IMPL(sys_errno, level, __PRETTY_FUNCTION__, __LINE__, __VA_ARGS__)
#			define ACS_ACA_SYSLOG(syslog_priority, level, ...) ACS_ACA_SYSLOG_SOURCE_IMPL(syslog_priority, level, __PRETTY_FUNCTION__, __LINE__, __VA_ARGS__)
#			define ACS_ACA_SYSLOG_ERRNO(sys_errno, syslog_priority, level, ...) ACS_ACA_SYSLOG_SOURCE_ERRNO_IMPL(sys_errno, syslog_priority, level, __PRETTY_FUNCTION__, __LINE__, __VA_ARGS__)
#		else
#			define ACS_ACA_LOG(level, ...) ACS_ACA_LOG_SOURCE_IMPL(level, __func__, __LINE__, __VA_ARGS__)
#			define ACS_ACA_LOG_ERRNO(sys_errno, level, ...) ACS_ACA_LOG_SOURCE_ERRNO_IMPL(sys_errno, level, __func__, __LINE__, __VA_ARGS__)
#			define ACS_ACA_SYSLOG(syslog_priority, level, ...) ACS_ACA_SYSLOG_SOURCE_IMPL(syslog_priority, level, __func__, __LINE__, __VA_ARGS__)
#			define ACS_ACA_SYSLOG_ERRNO(sys_errno, syslog_priority, level, ...) ACS_ACA_SYSLOG_SOURCE_ERRNO_IMPL(sys_errno, syslog_priority, level, __func__, __LINE__, __VA_ARGS__)
#		endif // ACS_ACA_LOGGING_USE_PRETTY_FUNCTION
#	else
#		define ACS_ACA_LOG(level, ...) ACS_ACA_LOG_IMPL(level, __VA_ARGS__)
#		define ACS_ACA_LOG_ERRNO(sys_errno, level, ...) ACS_ACA_LOG_ERRNO_IMPL(sys_errno, level, __VA_ARGS__)
#		define ACS_ACA_SYSLOG(syslog_priority, level, ...) ACS_ACA_SYSLOG_IMPL(syslog_priority, level, __VA_ARGS__)
#		define ACS_ACA_SYSLOG_ERRNO(sys_errno, syslog_priority, level, ...) ACS_ACA_SYSLOG_ERRNO_IMPL(sys_errno, syslog_priority, level, __VA_ARGS__)
#	endif //ACS_ACA_LOGGING_HAS_SOURCE_INFO
#else
#	define ACS_ACA_LOG(level, ...) ACS_ACA_LOG_NO_LOGGING()
#	define ACS_ACA_LOG_ERRNO(sys_errno, level, ...) ACS_ACA_LOG_NO_LOGGING()
#	define ACS_ACA_SYSLOG(syslog_priority, level, ...) ACS_ACA_LOG_NO_LOGGING()
#	define ACS_ACA_SYSLOG_ERRNO(sys_errno, syslog_priority, level, ...) ACS_ACA_LOG_NO_LOGGING()
#endif //ACS_ACA_HAS_LOGGING
...
#if defined (ACS_ACA_HAS_DUMPING)
#	define ACS_ACA_LOG_DUMP(buffer, size, ...) ACS_ACA_LOGGER_CLASS::ACS_ACA_DUMPER_METHOD(buffer, size, __VA_ARGS__)
#else
#	define ACS_ACA_LOG_DUMP(buffer, size, ...) ACS_ACA_LOG_NO_LOGGING()
#endif

#undef __CLASS_NAME__
#define __CLASS_NAME__ HEADER_GUARD_CLASS__acs_aca_logger

/** @class acs_aca_logger acs_aca_logger.h
 *	@brief acs_aca_logger class
 *	@author xnicmut (Nicola Muto)
 *	@date 2013-05-10
 *
 *	acs_aca_logger Class detailed description
 */
...
private:
	...
	//==============//
private:
	/** @brief acs_aca_logger Default constructor
	 *
	 *	acs_aca_logger Constructor detailed description
	 *
	...
	/** @brief acs_aca_logger Copy constructor
	 *
	 *	acs_aca_logger Copy Constructor detailed description
	 *
	...
	//============//
public:
	/** @brief acs_aca_logger Destructor
	 *
	 *	acs_aca_logger Destructor detailed description
	 *
	 *	@remarks Remarks
	 */
...
public:
	...
	static void dump (uint8_t * buffer, size_t size, size_t dumping_size, size_t dumping_line_length = ACS_ACA_DEFAULT_DUMP_LINE_LENGTH);
...
#endif // HEADER_GUARD_CLASS__acs_aca_logger
