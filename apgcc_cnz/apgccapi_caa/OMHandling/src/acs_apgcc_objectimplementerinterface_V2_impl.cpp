/*
 * acs_apgcc_objectimplementerinterface_V2_impl.cpp
 *
...
namespace {
	ACS_TRA_trace trace(const_cast<char*>("acs_apgcc_objectimplementerinterface_V2"), const_cast<char *>("C300"));
}



acs_apgcc_objectimplementerinterface_V2_impl::acs_apgcc_objectimplementerinterface_V2_impl():objName(), impName(){
...
acs_apgcc_objectimplementerinterface_V2_impl::acs_apgcc_objectimplementerinterface_V2_impl(string p_impName ):objName(), impName(p_impName){
...
acs_apgcc_objectimplementerinterface_V2_impl::acs_apgcc_objectimplementerinterface_V2_impl(string p_objName, string p_impName, ACS_APGCC_ScopeT p_scope ) {
...
acs_apgcc_objectimplementerinterface_V2_impl::acs_apgcc_objectimplementerinterface_V2_impl(acs_apgcc_objectimplementerinterface_V2_impl &objImp){
...
acs_apgcc_objectimplementerinterface_V2_impl& acs_apgcc_objectimplementerinterface_V2_impl::operator=(const acs_apgcc_objectimplementerinterface_V2_impl &objImp){
...
std::string acs_apgcc_objectimplementerinterface_V2_impl::getObjName(){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::getObjName()");
...
void acs_apgcc_objectimplementerinterface_V2_impl::setObjName(std::string p_objName){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::setObjName(std::string p_objName)");
		trace.ACS_TRA_event(1, buffer);
	}
...
std::string acs_apgcc_objectimplementerinterface_V2_impl::getImpName(){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::getImpName()");
		trace.ACS_TRA_event(1, buffer);
	}
...
void acs_apgcc_objectimplementerinterface_V2_impl::setImpName(std::string p_impName){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::setImpName(std::string p_impName)");
		trace.ACS_TRA_event(1, buffer);
	}
...
SaUint64T acs_apgcc_objectimplementerinterface_V2_impl::getImmOiHandle(){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::getImmOiHandle()");
		trace.ACS_TRA_event(1, buffer);
	}
...
void acs_apgcc_objectimplementerinterface_V2_impl::setImmOiHandle(SaUint64T immOiHandle){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::setImmOiHandle(SaUint64T immOiHandle)");
		trace.ACS_TRA_event(1, buffer);
	}
...
ACS_APGCC_ScopeT acs_apgcc_objectimplementerinterface_V2_impl::getScope(){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::getScope()");
		trace.ACS_TRA_event(1, buffer);
	}
...
void acs_apgcc_objectimplementerinterface_V2_impl::setScope(ACS_APGCC_ScopeT p_scope){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::setScope(ACS_APGCC_ScopeT p_scope)");
		trace.ACS_TRA_event(1, buffer);
	}
...
int acs_apgcc_objectimplementerinterface_V2_impl::getSelObj() const{

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::getSelObj() const");
		trace.ACS_TRA_event(1, buffer);
	}
...
void acs_apgcc_objectimplementerinterface_V2_impl::setSelObj(SaSelectionObjectT p_selObj){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::setSelObj(SaSelectionObjectT p_selObj)");
		trace.ACS_TRA_event(1, buffer);
	}
...
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::dispatch(ACS_APGCC_DispatchFlags p_flag){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::dispatch(ACS_APGCC_DispatchFlags p_flag)");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	if (errorCode != SA_AIS_OK){
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::dispatch():saImmOiDispatch:FAILED", LOG_LEVEL_ERROR);
...
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::modifyRuntimeObj(const char* p_objName, ACS_CC_ImmParameter* p_attributeValue){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::modifyRuntimeObj(const char* p_objName, ACS_CC_ImmParameter* p_attributeValue)");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	if(errorCode!=SA_AIS_OK){
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::modifyRuntimeObj():saImmOiRtObjectUpdate_2:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::adminOperationResult(ACS_APGCC_OiHandle oiHandle,ACS_APGCC_InvocationType invocation, int result){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::adminOperationResult(ACS_APGCC_OiHandle oiHandle,ACS_APGCC_InvocationType invocation, int result)");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	if (errorCode != SA_AIS_OK){
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::adminOperationResult::saImmOiAdminOperationResult:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
void acs_apgcc_objectimplementerinterface_V2_impl::setExitCode(int p_exitCode, string p_exitCodeMessage ) {

	//exitCode = p_exitCode;

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::setExitCode(int p_exitCode, string p_exitCodeMessage )");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	log.Write("acs_apgcc_objectimplementerinterface_V2::setExitCode():", LOG_LEVEL_ERROR);
	log.Write(buffer, LOG_LEVEL_ERROR);
...
void acs_apgcc_objectimplementerinterface_V2_impl::setExitCode(int p_exitCode ) {
...
string acs_apgcc_objectimplementerinterface_V2_impl::getExitCodeString( ) {

	if (trace.ACS_TRA_ON()){
			char buffer[1024] = {0};
			sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::getExitCodeString()");
			trace.ACS_TRA_event(1, buffer);
		}
...
SaAisErrorT acs_apgcc_objectimplementerinterface_V2_impl::getExitCode( ) {
...
//---------------------------------------------------------------------------------------------------------------------------
int acs_apgcc_objectimplementerinterface_V2_impl::getInternalLastError(){
...
//---------------------------------------------------------------------------------------------------------------------------
void acs_apgcc_objectimplementerinterface_V2_impl::setInternalError(int p_errorCode){
...
//---------------------------------------------------------------------------------------------------------------------------
const char* acs_apgcc_objectimplementerinterface_V2_impl::getInternalLastErrorText(){
...
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::getCcbAugmentationInitialize(ACS_APGCC_OiHandle oiHandle, ACS_APGCC_CcbId ccbId, ACS_APGCC_CcbHandle* ccbHandle, ACS_APGCC_AdminOwnerHandle* adminOwnerHandler){
	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::getCcbAugmentationInitialize()");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	if (errorCode != SA_AIS_OK ){
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::getCcbAugmentationInitialize::saImmOiAugmentCcbInitialize:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::createObjectAugmentCcb(  ACS_APGCC_CcbHandle ccbHandle, ACS_APGCC_AdminOwnerHandle adminOwnerHandler, const char* p_className, const char* p_parentName, vector<ACS_CC_ValuesDefinitionType> p_attrValuesList){
	/*start*/
	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::createObjectAugmentCcb(  ACS_APGCC_CcbHandle ccbHandle, ACS_APGCC_AdminOwnerHandle adminOwnerHandler, const char* p_className, const char* p_parentName, vector<ACS_CC_ValuesDefinitionType> p_attrValuesList)");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	if (p_parentName != 0){
		...
		if (errorCode != SA_AIS_OK)	{
			...
			log.Write("acs_apgcc_objectimplementerinterface_V2::createObjectAugmentCcb():saImmOmAdminOwnerSet:FAILED", LOG_LEVEL_ERROR);
			log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if (errorCode != SA_AIS_OK ){
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::createObjectAugmentCcb:saImmOmCcbObjectCreate_2:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
//---------------------------------------------------------------------------------------------------------------------------
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::modifyObjectAugmentCcb( ACS_APGCC_CcbHandle ccbHandle, ACS_APGCC_AdminOwnerHandle adminOwnerHandler, const char* p_objectName, ACS_CC_ImmParameter* p_attributeValue){
	/*start*/
	...
	if (errorCode != SA_AIS_OK)	{
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::modifyObjectAugmentCcb()::saImmOmAdminOwnerSet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
//---------------------------------------------------------------------------------------------------------------------------
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::deleteObjectAugmentCcb(  ACS_APGCC_CcbHandle ccbHandle, ACS_APGCC_AdminOwnerHandle adminOwnerHandler, const char* m_objectName){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::deleteObjectAugmentCcb(  ACS_APGCC_CcbHandle ccbHandle, ACS_APGCC_AdminOwnerHandle adminOwnerHandler, const char* m_objectName)");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	if (errorCode != SA_AIS_OK)	{
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2_impl::deleteObjectAugmentCcb()::saImmOmAdminOwnerSet:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
	...
	if((errorCode = saImmOmCcbObjectDelete(ccbHandle, &objToDelete ))!= SA_AIS_OK){
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::deleteObjectAugmentCcb::saImmOmCcbObjectDelete:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
// applyAugmentCcb
//---------------------------------------------------------------------------------------------------------------------------
ACS_CC_ReturnType acs_apgcc_objectimplementerinterface_V2_impl::applyAugmentCcb(  ACS_APGCC_CcbHandle ccbHandle){

	if (trace.ACS_TRA_ON()){
		char buffer[1024] = {0};
		sprintf(buffer, "acs_apgcc_objectimplementerinterface_V2::applyAugmentCcb(ACS_APGCC_CcbHandle ccbHandle");
		trace.ACS_TRA_event(1, buffer);
	}
	...
	if ((errorCode = saImmOmCcbApply(ccbHandle))!= SA_AIS_OK){
		...
		log.Write("acs_apgcc_objectimplementerinterface_V2::applyAugmentCcb::saImmOmCcbApply:FAILED", LOG_LEVEL_ERROR);
		log.Write(buffer, LOG_LEVEL_ERROR);
...
acs_apgcc_objectimplementerinterface_V2_impl::~acs_apgcc_objectimplementerinterface_V2_impl(){
