...
MyImplementer_2::MyImplementer_2(string p_impName ):acs_apgcc_objectimplementerinterface_V3(p_impName){

}

MyImplementer_2::MyImplementer_2(string p_objName, string p_impName, ACS_APGCC_ScopeT p_scope ): acs_apgcc_objectimplementerinterface_V3(p_objName, p_impName, p_scope){
