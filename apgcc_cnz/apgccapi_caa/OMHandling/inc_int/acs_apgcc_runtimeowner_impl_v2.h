/*
 * acs_apgcc_runtimeowner_impl_v2.h
 *
 *  Created on: Aug 31, 2011
 *      Author: xfabron
 */

#ifndef ACS_APGCC_RUNTIMEOWNER_IMPL_V2_H_
#define ACS_APGCC_RUNTIMEOWNER_IMPL_V2_H_
 ...
 *	@brief acs_apgcc_runtimeowner_impl_v2 class
...
public:
	...
	/** @brief acs_apgcc_runtimeowner_impl_v2 Default constructor
	 *
	 *	acs_apgcc_runtimeowner_impl_v2 Constructor of class
	 *
	 *	@remarks Remarks
	 */
	acs_apgcc_runtimeowner_impl_v2();


	/** @brief acs_apgcc_runtimeowner_impl_v2 Copy constructor
	 *
	 *	acs_apgcc_runtimeowner_impl_v2 Copy Constructor of class
	 *
	 *	@remarks Remarks
	 */
	acs_apgcc_runtimeowner_impl_v2(acs_apgcc_runtimeowner_impl_v2 *runtimeImp);


	/** @brief acs_apgcc_runtimeowner_impl_v2 Destructor
	 *
	 *	acs_apgcc_runtimeowner_impl_v2 Destructor of class
	 *
	 *	@remarks Remarks
	 */
	virtual ~acs_apgcc_runtimeowner_impl_v2();
	 ...
	 *
	 */
	ACS_CC_ReturnType init(std::string p_implementerName, ACS_APGCC_RuntimeOwner_V2 *runtimeOwn);
...
private:
	 ...
	 */
	static void adminOperationCallback(SaImmOiHandleT immOiHandle, SaInvocationT invocation, const SaNameT *objectName,
	...
	/**Attributes**/
	static map<SaUint64T, ACS_APGCC_RuntimeOwner_V2 *> implementerList;

	ACS_APGCC_RuntimeOwner_V2 *runtimeOwn;
...
#endif /* ACS_APGCC_RUNTIMEOWNER_IMPL_V2_H_ */
