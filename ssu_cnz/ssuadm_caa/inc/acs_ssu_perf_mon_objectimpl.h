//=============================================================================
/**
 *  @file    acs_ssu_perf_mon_objectimpl.h
 *
 ...
 *  @documentno
 *
 *  @brief  It acts as OI for handling IMM Callbacks of SSU performance monitor objects.
 *
 */
//=============================================================================
#ifndef ACS_SSU_PERFMONOBJECTIMPL_H
#define ACS_SSU_PERFMONOBJECTIMPL_H
...
/**
 * @brief ACS_SSU_Root_ObjectImpl
 * ACS_SSU_ObjectImpl class is extended from acs_apgcc_objectImplementereventhandler_V2.
 * It is having functions to handle IMM callbacks
 *
 */

class ACS_SSU_PerfMon_ObjectImpl:public acs_apgcc_objectimplementereventhandler_V2,public ACE_Task_Base
{
public:
	/**
	 * @brief
	 ...
	 */
	ACS_SSU_PerfMon_ObjectImpl(string szimpName );
   /**
   	* @brief
   	* destructor
   	*/
	~ACS_SSU_PerfMon_ObjectImpl();
	/**
