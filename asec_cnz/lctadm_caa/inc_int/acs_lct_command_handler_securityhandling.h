...
//
// NAME
//      acs_lct_command_handler_securityhandling.h
//
...
//			2012-25-04      XFURULL         First Release
//
//*********************************************************************
//
/*=====================================================================
...
#ifndef ACS_LCT_COMMANDHANDLER_BANNER_H
#define ACS_LCT_COMMANDHANDLER_BANNER_H
...
/*=================================================================== */
/**
    @class             ACS_LCT_CommandHandler_securityhandling 

    @brief              This class implements the IMM callback functionality 
**/
 /*=================================================================== */

class ACS_LCT_CommandHandler_securityhandling:public acs_apgcc_objectimplementereventhandler_V3,public ACE_Task_Base
{
/*=============================================================================
...
/*=====================================================================
 ...
 ==================================================================== */
	...
	ACS_LCT_CommandHandler_securityhandling(string szobjName,
		                   string szimpName,
        ...
        /*=================================================================== */
                ...
                */
        /*=================================================================== */
	~ACS_LCT_CommandHandler_securityhandling();
