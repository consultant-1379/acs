/*
 * acs_apgcc_objectimplementerinterface_V3_impl.h
 *
 *  Created on: Aug 25, 2011
 *      Author: xpaomaz
 */

#ifndef ACS_APGCC_OBJECTIMPLEMENTERINTERFACE_V3_IMPL_H_
#define ACS_APGCC_OBJECTIMPLEMENTERINTERFACE_V3_IMPL_H_
...
public:
	 ...
	 *	@remarks Remarks
	 */
	acs_apgcc_objectimplementerinterface_V3_impl();


	/** @brief acs_apgcc_objectimplementerinterface_V3_impl constructor
	 *
	 *	acs_apgcc_objectimplementerinterface_V3_impl Constructor this constructor is used to define a Object Implementer
	 *	for a class
	 *
	 *	@param p_impName Name of the Object Implementer
	 *
	 */
	acs_apgcc_objectimplementerinterface_V3_impl(string p_impName );
	 ...
	 *
	 */
	acs_apgcc_objectimplementerinterface_V3_impl(string p_objName, string p_impName, ACS_APGCC_ScopeT p_scope );


	/** @brief acs_apgcc_objectimplementerinterface_V3_impl Destructor
	 *
	 *	acs_apgcc_objectimplementerinterface_V3_impl Destructor
	 *
	 *	@remarks Remarks
	 */
	virtual ~acs_apgcc_objectimplementerinterface_V3_impl();
...
private:
	...
	acs_apgcc_objectimplementerinterface_V3_impl(acs_apgcc_objectimplementerinterface_V3_impl &objImp);

	acs_apgcc_objectimplementerinterface_V3_impl& operator=(const acs_apgcc_objectimplementerinterface_V3_impl &objImp);
...
#endif /* ACS_APGCC_OBJECTIMPLEMENTERINTERFACE_V3_IMPL_H_ */
