...
// AUTHOR 
// 	1995-06-13 by ETX/TX/T XKKHEIN
...
char* ACS_USA_formatTable[] =
{
	"",								// as if initial
		"%H:%M",						// time
		"%H:%M:%S",                     // localeTime
		"%I:%M:%S %p",					// time with AM or PM
		"%m/%d/%y",                     // localeDate
		"%a %b %d %H:%M:%S %Y",         // localeDateTime
		"%a %b %e %H:%M:%S %Z %Y"       // dateCall
};
...
const char* const	ampmTable[]  = 		// Table holding AM PM strings
{
	"AM",
		"PM"		// postMeridiem
};
...
const char* const monthTable[] = 			// Table for months
{
    "Jan", "Feb", "Mar", "Apr",
		"May", "Jun", "Jul", "Aug",
		"Sep", "Oct", "Nov", "Dec"
