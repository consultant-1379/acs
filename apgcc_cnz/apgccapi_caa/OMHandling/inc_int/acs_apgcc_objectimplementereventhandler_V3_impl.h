/*
 * acs_apgcc_objectimplementereventhandler_V3_impl.h
 *
 *  Created on: Aug 26, 2011
 *      Author: xpaomaz
 */

#ifndef ACS_APGCC_OBJECTIMPLEMENTEREVENTHANDLER_V3_IMPL_H_
#define ACS_APGCC_OBJECTIMPLEMENTEREVENTHANDLER_V3_IMPL_H_
...
class acs_apgcc_objectimplementereventhandler_V3;

/** @class acs_apgcc_objectimplementereventhandler_V3_impl acs_apgcc_objectimplementereventhandler_V3_impl.h
 *	@brief acs_apgcc_objectimplementereventhandler_V3_impl class
...
class acs_apgcc_objectimplementereventhandler_V3_impl {
...
public:
	...
	/** @brief acs_apgcc_objectimplementereventhandler_V3_impl constructor
	 *
	 *	acs_apgcc_objectimplementereventhandler_V3_impl Constructor this constructor is used to define a Object Implementer
	 *	for a class
	 *
	 *	@param p_impName Name of the Object Implementer
	 *
	 */
	acs_apgcc_objectimplementereventhandler_V3_impl();
	 ...
	 *
	 */
//	acs_apgcc_objectimplementereventhandler_V3_impl(string p_objName, string p_impName, ACS_APGCC_ScopeT p_scope );
	 ...
	 *
	 */
	void dispatch(ACE_Reactor *p_reactor, ACS_APGCC_DispatchFlags p_flag, acs_apgcc_objectimplementereventhandler_V3 *eventHanlder);
	 ...
	 *
	 */
	int register_handle(acs_apgcc_objectimplementereventhandler_V3 *eventHanlder);
	 ...
	 *
	 */
	int get_handle (acs_apgcc_objectimplementereventhandler_V3 *eventHanlder);
	 ...
	 *
	 */
	int release_handle(acs_apgcc_objectimplementereventhandler_V3 *eventHanlder);
...
#endif /* ACS_APGCC_OBJECTIMPLEMENTEREVENTHANDLER_V3_IMPL_H_ */
