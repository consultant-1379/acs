...
void classImplTest_4(){
	...
	ASSERTM("ACS_APGCC_OiHandler::addClassImpl for implementer_1 ", result == ACS_CC_SUCCESS);

	result = oiHandler.addClassImpl(&implementer_2, nameClass_2);
	ASSERTM("ACS_APGCC_OiHandler::addClassImpl for implementer_2", result == ACS_CC_FAILURE);

	result = oiHandler.removeClassImpl(&implementer_1, nameClass_1);
	ASSERTM("ACS_APGCC_OiHandler::removeClassImpl for implementer_1 ", result == ACS_CC_SUCCESS);
...
void classImplTest_5(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " ACS_APGCC_OiHandler::removeClassImpl(...) " << endl;
...
void classImplTest_6(){
	...
	result = oiHandler.removeClassImpl(&implementer_1, nameClass);
	ASSERTM("ACS_APGCC_OiHandler::removeClassImpl ", result == ACS_CC_FAILURE);
...
void objImplTest_1(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " ACS_APGCC_OiHandler::addObjectImpl(...) " << endl;
	...
	ASSERTM("ACS_APGCC_OiHandler::addObjectImpl  ", result == ACS_CC_SUCCESS);
...
void objImplTest_2(){
	...
	ASSERTM("ACS_APGCC_OiHandler::addObjectImpl  ", result == ACS_CC_FAILURE);

	sleep(1);

	result = oiHandler.removeObjectImpl(&implementer_1);
	ASSERTM("ACS_APGCC_OiHandler::removeObjectImpl - implementer_1 ", result == ACS_CC_SUCCESS);

	result = oiHandler.removeObjectImpl(&implementer_2);
//	ASSERTM("ACS_APGCC_OiHandler::removeObjectImpl ", result == ACS_CC_FAILURE);
...
void objImplTest_5(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " ACS_APGCC_OiHandler::removeObjectImpl(...) " << endl;
...
void ModifyCallbackTest(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " ACS_APGCC_OiHandler::ModifyCallback(...) " << endl;
...
void abortCallbackTest(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " ACS_APGCC_OiHandler::AbortCallback(...) " << endl;
...
void updateCallbackTest(){
	...
	cout << " -----------------------------------------------------------------------------------" << endl;
	cout << " ACS_APGCC_OiHandler::OiRtAttUpdateCallback(...) " << endl;
