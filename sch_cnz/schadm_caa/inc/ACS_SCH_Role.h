...
class ACS_SCH_Role: public acs_apgcc_objectimplementereventhandler_V3, public ACE_Task_Base
{
public:
	/**
	 * @brief
	 ...
	 */
	ACS_SCH_Role( std::string ClassName, std::string p_impName, ACS_APGCC_ScopeT p_scope);
	ACS_SCH_Role( std::string ClassName, std::string p_impName, ACS_APGCC_ScopeT p_scope, ACE_Thread_Manager *aThrmgr);
	...
	acs_apgcc_oihandler_V3 *theRoleHandler;
