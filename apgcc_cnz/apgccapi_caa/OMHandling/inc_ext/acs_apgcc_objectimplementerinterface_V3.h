/*
 * acs_apgcc_objectimplementerinterface_V3.h
 *
 *  Created on: Aug 25, 2011
 *      Author: xpaomaz
 */

#ifndef ACS_APGCC_OBJECTIMPLEMENTERINTERFACE_V3_H_
#define ACS_APGCC_OBJECTIMPLEMENTERINTERFACE_V3_H_
...
using namespace std;
class acs_apgcc_objectimplementerinterface_V3_impl;



/** @class acs_apgcc_objectimplementerinterface_V3 acs_apgcc_objectimplementerinterface_V3.h
 *	@brief acs_apgcc_objectimplementerinterface_V3 class
 *	@author xpaomaz (Paola Mazzone) & xfabron (Fabio Ronca)
 *	@date 2010-09-13
 *	@version R1A
 *
 *	acs_apgcc_objectimplementerinterface_V3 Class detailed description
 */

class acs_apgcc_objectimplementerinterface_V3 {

	//=========//
	// Friends //
	//=========//
	friend class acs_apgcc_oihandler_V3_impl;
...
public:
	...
	/** @brief acs_apgcc_objectimplementerinterface_V3 Default constructor
	 *
	 *	acs_apgcc_objectimplementerinterface_V3 Constructor
	 *
	 *	@remarks Remarks
	 */
	...
	/** @brief acs_apgcc_objectimplementerinterface_V3 constructor
	 *
	 *	acs_apgcc_objectimplementerinterface_V3 Constructor this constructor is used to define a Object Implementer
	 *	for a class
	 *
	 *	@param p_impName Name of the Object Implementer
	 *
	 */
	acs_apgcc_objectimplementerinterface_V3(string p_impName );
	 ...
	 *
	 */
	acs_apgcc_objectimplementerinterface_V3(string p_objName, string p_impName, ACS_APGCC_ScopeT p_scope );
	...
	/** @brief acs_apgcc_objectimplementerinterface_V3 Destructor
	 *
	 *	acs_apgcc_objectimplementerinterface_V3 Destructor
	 *
	 *	@remarks Remarks
	 */
	virtual ~acs_apgcc_objectimplementerinterface_V3();
...
private:
	...
	acs_apgcc_objectimplementerinterface_V3_impl *objectImplInt_impl;

	acs_apgcc_objectimplementerinterface_V3(acs_apgcc_objectimplementerinterface_V3 &objImp);

	acs_apgcc_objectimplementerinterface_V3& operator=(const acs_apgcc_objectimplementerinterface_V3 &objImp);
...
#endif /* ACS_APGCC_OBJECTIMPLEMENTERINTERFACE_V3_H_ */
